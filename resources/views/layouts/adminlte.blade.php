...
<head>
 ...
 <!-- select2 -->
 <link rel="stylesheet" href="{{asset('public/asset/plugins/select2/css/select2.min.css')}}">
  <!-- Font Awesome -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <a href="#" class="brand-link sidebar-dark-primary elevation-4">
      <img src="{{asset('public/asset/dist/img/AdminLTELogo.png')}}"
           alt="AdminLTE Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-white">Perpustakaan</span>
    </a>
...
<script src="{{asset('public/asset/plugins/bs-notify.min.js')}}"></script>
@stack('script')
</body>
</html>
